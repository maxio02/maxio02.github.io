var links = Array.prototype.slice.call(document.querySelectorAll('.no-js-link'));
...
backButtons.forEach(button => {
  ...
  backButtons.push(button.firstElementChild.firstElementChild)
});
...
document.querySelector('#main-container').addEventListener('click', exitItem, false);
